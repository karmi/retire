...
# TODO: Figure out why activerecord-3.0.7/lib/active_record/connection_adapters/sqlite3_adapter.rb
#       gives Segmentation fault. For now, the test is simply disabled.
#
if RUBY_VERSION < "1.9"
  module Tire
